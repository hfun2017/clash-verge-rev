...
// Use the stub DownloadEvent from src/services/update so the
// event-handler code type-checks. (When checkUpdateSafe returns null,
// this handler never runs anyway.)
